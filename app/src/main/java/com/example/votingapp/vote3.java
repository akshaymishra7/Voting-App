...
public class vote3 extends AppCompatActivity {
        TextView cand1, cand2,cand3;
        ...
        protected void onCreate(Bundle savedInstanceState) {
                ...
                btn4 = findViewById(R.id.confirm);
                mp = MediaPlayer.create(this, R.raw.beep);



                final AlertDialog.Builder alert=new AlertDialog.Builder(vote3.this);
                ...
                confirm.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                                ...
                                if(password1.equals("voting")){
                                        Intent intent=new Intent(vote3.this,result3.class);
